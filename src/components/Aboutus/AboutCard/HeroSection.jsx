...
import { FaArrowRight, FaCode, FaMobile, FaCloud, FaChartLine } from "react-icons/fa";
...
const ServiceHeroSection = () => {
  ...
  const serviceIcons = [
    { Icon: FaCode, label: "Development", color: "from-blue-500 to-cyan-500" },
    { Icon: FaMobile, label: "Mobile Apps", color: "from-purple-500 to-pink-500" },
    { Icon: FaCloud, label: "Cloud Solutions", color: "from-emerald-500 to-teal-500" },
    { Icon: FaChartLine, label: "Analytics", color: "from-orange-500 to-red-500" },
  ];
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tight">
                ...
                <span className="block text-white">Businesses with</span>
            ...
            >
              {serviceIcons.map((service, idx) => (
                ...
                >
                  <div className={`w-12 h-12 bg-gradient-to-br ${service.color} rounded-lg flex items-center justify-center shadow-lg`}>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="text-xs text-blue-100 font-medium mt-1 whitespace-nowrap">Fast Delivery</div>
              </motion.div>
              ...
              >
                <div className="text-2xl">🎯</div>
                <div className="text-xs text-cyan-100 font-medium mt-1 whitespace-nowrap">Quality First</div>
              </motion.div>
              ...
              >
                <div className="text-2xl">💎</div>
                <div className="text-xs text-teal-100 font-medium mt-1 whitespace-nowrap">Premium Support</div>
              </motion.div>
            </motion.div>
          </motion.div>
        </div>
