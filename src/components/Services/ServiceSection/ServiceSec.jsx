...
const ServiceCard = ({ service }) => {
  ...
  return (
    <>
      <div
        className="group relative bg-white rounded-2xl p-5 sm:p-6 shadow-md hover:shadow-2xl transition-shadow duration-200 cursor-pointer border border-slate-100 overflow-hidden mt-6 sm:mt-8 lg:mt-10"
      ...
      >
        ...
        />
        <div
          className={`absolute -top-12 -right-12 w-28 h-28 sm:w-32 sm:h-32 bg-gradient-to-br ${service.gradient} opacity-10 rounded-full blur-2xl group-hover:opacity-20 transition-opacity`}
        />

        <div className="relative z-10 space-y-4">
          <div
            className={`w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br ${service.gradient} rounded-xl flex items-center justify-center shadow-md`}
          >
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-slate-700 group-hover:text-blue-600 transition-colors pt-2">
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-white rounded-2xl sm:rounded-3xl w-full max-w-xl sm:max-w-2xl lg:max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl mx-auto"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="relative bg-gradient-to-br from-teal-500 to-teal-600 p-6 sm:p-8 overflow-hidden">
              <button
                className="absolute top-4 right-4 sm:top-6 sm:right-6 w-9 h-9 sm:w-10 sm:h-10 bg-white/90 rounded-lg flex items-center justify-center text-teal-700 hover:bg-white transition-all shadow-md z-10"
                onClick={() => setShowModal(false)}
              >
            ...
            {/* Modal Content */}
            <div className="p-5 sm:p-8 overflow-y-auto max-h-[calc(90vh-230px)] sm:max-h-[calc(90vh-260px)] bg-white">
              <div className="mb-7 sm:mb-8">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                  <div className="w-1 h-6 sm:h-7 bg-teal-500 rounded-full" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  {service.features.map((feature, idx) => (
                    <div
                      key={idx}
                      className="flex items-center gap-3 p-3 sm:p-4 bg-white rounded-xl border border-slate-200 hover:border-teal-300 hover:shadow-sm transition-all"
                    >
              ...
              {/* CTA Section */}
              <div className="relative bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl p-4 sm:p-6 overflow-hidden">
                <div className="relative">
                  <p className="text-white font-semibold text-sm sm:text-base mb-3 sm:mb-4">
                    Ready to transform your business with {service.title}?
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link href="/contactus">
                      <button className="w-full sm:w-auto px-5 sm:px-6 py-2.5 bg-white text-teal-700 rounded-xl font-semibold hover:shadow-lg transition-all text-sm">
                        Get Started
                      </button>
                    </Link>
                    <Link href="/contactus">
                      <button className="w-full sm:w-auto px-5 sm:px-6 py-2.5 bg-white/20 backdrop-blur-sm text-white rounded-xl font-semibold hover:bg-white/30 transition-all text-sm border border-white/30">
                        Learn More
                      </button>
                    </Link>
                  </div>
            ...
            {/* Modal Footer */}
            <div className="px-5 sm:px-8 py-4 sm:py-5 bg-slate-50 border-t border-slate-200">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                ...
                <button
                  className="w-full sm:w-auto px-5 sm:px-6 py-2.5 bg-teal-500 text-white font-semibold rounded-xl hover:bg-teal-600 transition-all text-sm shadow-md"
                  onClick={() => setShowModal(false)}
                >
                  Close
                </button>
...
const ServicesSection = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-br from-slate-50 via-white to-slate-100 py-16 sm:py-20 lg:py-32 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-[280px] sm:w-[400px] lg:w-[600px] h-[280px] sm:h-[400px] lg:h-[600px] bg-gradient-to-br from-blue-100/40 via-purple-100/30 to-transparent rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-[260px] sm:w-[360px] lg:w-[500px] h-[260px] sm:h-[360px] lg:h-[500px] bg-gradient-to-tr from-cyan-100/40 via-teal-100/30 to-transparent rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-14 sm:mt-16 lg:mt-20 text-center">
          <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-2xl sm:rounded-3xl p-7 sm:p-10 lg:p-12 relative overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 w-56 sm:w-72 lg:w-96 h-56 sm:h-72 lg:h-96 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-48 sm:w-64 lg:w-80 h-48 sm:h-64 lg:h-80 bg-gradient-to-tr from-cyan-500/20 to-teal-500/20 rounded-full blur-3xl" />
            ...
            <div className="relative z-10 space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mt-4 sm:mt-6 lg:mt-8">
                <Link href="/contactus">
                  <button className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all text-sm sm:text-base">
                    Schedule Consultation
                  </button>
                </Link>
                {/* You can re-enable secondary button if needed */}
              </div>
            </div>
          </div>
        </div>
