...
import { Award, Users, Shield, TrendingUp, Zap, Clock, CheckCircle2, Star } from "lucide-react";
              ...
              <div className="relative bg-white p-3 rounded-2xl shadow-2xl">
                ...
                <div className="absolute -top-4 -right-4 bg-white px-5 py-3 rounded-xl shadow-xl border border-gray-100">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Partner Status</p>
                      <p className="text-sm font-bold text-yellow-600">Gold Certified</p>
                    </div>
                  </div>
                </div>
