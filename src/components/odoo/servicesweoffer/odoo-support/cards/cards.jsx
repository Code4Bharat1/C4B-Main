...
const EcommerceBenefits = () => {
  return (
    ...
    >
      <div className="container mx-auto grid grid-cols-1 gap-8 sm:grid-cols-2 px-6 sm:px-12 lg:px-20">
        {/* Card 1 */}
        ...
        <div className="group bg-white shadow-lg rounded-lg p-4 sm:p-6 h-auto sm:h-[480px] w-full sm:w-[560px] transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
          <div className="flex items-center mb-4">
            ...
            />
            <h3 className="text-lg sm:text-[20px] font-[1000] text-gray-800">
               Odoo Support Services at odoo Implementers 
            </h3>
          </div>
            <ul className="list-disc list-inside text-gray-600 text-sm sm:text-base space-y-2">
            <div>
            Odoo Implementers work closely with clients to ensure seamless and uninterrupted business flow. Our eminent support system takes business to great heights. We provide,
            </div>
