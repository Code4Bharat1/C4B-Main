...
import { FaHome, FaCogs, FaChevronRight, FaRocket, FaBolt, FaHeadset, FaLifeRing } from 'react-icons/fa';
  ...
  return (
    <div className="relative pt-[94px] h-[calc(81vh-4rem)] sm:h-[60vh] overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        <img
          src="/images/bg-image/odoo-support.jpg"
          alt="Odoo Support Background"
      ...
      <div className="relative z-10 flex flex-col h-full w-full justify-between px-6 sm:px-12 lg:px-24 py-8">
            ...
            <div className="flex flex-col items-end gap-3">
              ...
              <div className="flex flex-wrap justify-end items-center gap-2">
                ...
                <div className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full shadow-lg border border-white/30">
                  <span className="font-bold text-white text-sm">Odoo Support</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap justify-end gap-2">
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white/15 backdrop-blur-md rounded-full border border-white/30">
                  ...
                  <span className="text-white text-xs font-semibold">Quick Response</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white/15 backdrop-blur-md rounded-full border border-white/30">
                  <FaLifeRing className="text-pink-300 text-xs" />
                  <span className="text-white text-xs font-semibold">Expert Help</span>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 bg-white/15 backdrop-blur-md rounded-full border border-white/30">
        ...
        <div className="mt-auto">
          ...
          <p className="text-white/95 text-xl sm:text-2xl font-medium mb-8 max-w-xl drop-shadow-lg">
            Expert assistance for your Odoo ERP system anytime, anywhere
          </p>
