...
import { FaShoppingCart, FaCheckCircle, FaRocket, FaGlobe, FaArrowRight, FaStar, FaMobile, FaDollarSign } from 'react-icons/fa';

const EcommerceSection = () => {
  const [isHovered, setIsHovered] = useState(false);

  const features = [
    { icon: FaShoppingCart, text: "Online Store", color: "from-purple-500 to-pink-500" },
    { icon: FaGlobe, text: "Global Reach", color: "from-blue-500 to-cyan-500" },
    { icon: FaMobile, text: "Mobile Ready", color: "from-green-500 to-emerald-500" }
  ];

  const benefits = [
    { icon: FaRocket, text: "Boost Sales" },
    { icon: FaMobile, text: "Mobile App" },
      ...
      <div className="container mx-auto px-6 sm:px-12 lg:px-24 grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-20 relative z-10">
        ...
        <div className="text-center lg:text-left animate-fade-in-right">
          ...
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-5 py-2 rounded-full mb-6 shadow-lg animate-fade-in">
            ...
            <span className="font-bold uppercase text-xs tracking-wider">E-Commerce</span>
          </div>

          {/* Main Heading */}
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-6 leading-tight">
            <span className="text-slate-800">Establish a </span>
            <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
              Powerful Online Business
            </span>
            <br />
            <span className="text-slate-800 text-2xl sm:text-3xl">with Odoo E-commerce</span>
          </h2>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg mb-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow duration-300">
            <p className="text-slate-700 leading-relaxed text-justify">
              The past decade witnessed a tremendous change in customers' shopping behavior and purchase patterns. <span className="font-semibold text-purple-600">E-commerce services</span> with futuristic online features influence value-added services. Boost business sales and reach more loyal customers with <span className="font-semibold text-pink-600">Odoo Ecommerce</span>.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 shadow-lg mb-6 hover:shadow-xl transition-shadow duration-300">
            <p className="text-slate-700 leading-relaxed text-justify">
              Build an authentic online store in no time and connect with your potential business prospects worldwide with <span className="font-semibold text-purple-600">Odoo E-commerce</span>. <span className="font-semibold text-pink-600">Odoo Implementers'</span> mobilized and customized E-commerce mobile app development technology is feasible to work from anywhere and anytime. Bootstrapped budget for easy business expansion as demand grows.
            </p>
          </div>
            ...
            >
              <button className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-bold text-base px-8 py-4 rounded-full shadow-2xl hover:shadow-pink-500/50 hover:scale-110 transition-all duration-300 overflow-hidden">
                ...
                <span className="relative z-10 flex items-center gap-3">
                  <FaShoppingCart className={`text-xl transition-transform duration-300 ${isHovered ? 'scale-110' : ''}`} />
                  View All Services
