    ...
    <section className="relative bg-white py-16 sm:py-24">
      <div className="container mx-auto px-6 lg:pl-48 lg:pr-48 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-4 sm:mt-4 lg:mt-[-80px]">
        ...
        <div className="pr-4 sm:pr-[79px] pl-4 sm:pl-[-1px]">
          <h2 className="text-[22px] sm:text-[28px] sm:text-3xl font-[1000] text-gray-800 mb-4 sm:mb-6 leading-snug text-center sm:text-left">
            Why Oodu Implementers as your E-commerce Website Development Company
          </h2>
        ...
        <div className="relative flex justify-center mt-8 sm:mt-0">
          <img
            src="https://www.odooimplementers.com/images/odoo-e-commerce-service.jpg"
