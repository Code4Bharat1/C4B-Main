...
const   Hero = () => {
  return (
    <div className="relative pt-[94px] h-[calc(81vh-4rem)] sm:h-[60vh]">
      ...
      {/* Text Content */}
      <div className="relative z-10 flex flex-col h-full w-full justify-center items-center sm:justify-between sm:flex-row px-4 sm:px-[7.5rem] bg-gradient-to-b from-transparent to-black/0">
        {/* Left Side - Main Title */}
        <h2 className="text-[24px] font-bold text-white text-center mb-4 sm:mb-0 sm:text-3xl">
        ...
        <Link href="/">
          ...
          <span className="hidden sm:block text-[#E1306C]">•</span>
          ...
          <span className="hidden sm:block text-[#E1306C]">•</span>
          <span className="text-white">Odoo Offshore Development</span>
        </div>
      </div>
    </div>
  );
