    ...
    <section className="bg-white py-16">
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 px-8 lg:pl-[11rem] lg:pr-[11rem] gap-[7rem]">
        ...
        <div className="flex flex-col justify-center">
          <h6 className="text-purple-700 text-[17px] font-bold mb-2 uppercase">BUSINESS OUTSOURCING SERVICES</h6>
          ...
          <p className="text-gray-500 text-base leading-relaxed mb-4">
            ...
            projects that require expertise and high-quality deliverables. Odoo Implementers take up
