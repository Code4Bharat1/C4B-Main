...
const EcommerceSection = () => {
  ...
  const features = [
    ...
    { icon: FaShieldAlt, text: "Quality Assured", color: "from-blue-500 to-cyan-500" }
  ];
        ...
        <div className="text-center lg:text-left animate-fade-in-right">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg mb-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow duration-300">
            <p className="text-slate-700 leading-relaxed text-justify">
              <span className="font-semibold text-purple-600">Odoo Customization</span> is a key to successful development for achieving desirable results. We at <span className="font-semibold text-pink-600">Odoo Implementers</span> understand the client's industry type and their requirements for a better Odoo Implementation. We guarantee customer satisfaction in return with exemplary development and service.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 shadow-lg mb-6 hover:shadow-xl transition-shadow duration-300">
            <p className="text-slate-700 leading-relaxed text-justify mb-4">
              <span className="font-semibold text-purple-600">Odoo Implementers</span> have experience in working with different industry verticals and offer the level of technical sophistication needed to achieve a successful outcome. We manage the Odoo Customization process by establishing a clear, company-wide definition of business requirements and project controls.
            </p>
            <p className="text-slate-700 leading-relaxed text-justify">
              We identify and prioritize functions that should be added as a part of the overall functionality of the existing system.
            </p>
          </div>
