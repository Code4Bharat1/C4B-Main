  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-32 right-[18%] w-3 h-3 bg-pink-300 rounded-full animate-float animation-delay-1000 opacity-50"></div>
        <div className="absolute bottom-28 left-[22%] w-2 h-2 bg-purple-300 rounded-full animate-float animation-delay-2000 opacity-60"></div>
        <div className="absolute top-40 right-[32%] w-2 h-2 bg-white rounded-full animate-float animation-delay-3000 opacity-80"></div>
        <div className="absolute bottom-32 right-[12%] w-3 h-3 bg-pink-400 rounded-full animate-float animation-delay-4000 opacity-50"></div>
      </div>
      ...
      <div className="relative z-10 px-6 sm:px-8 max-w-5xl mx-auto text-center">
        ...
        {/* Main Heading */}
        <h3 className="text-white font-extrabold text-3xl sm:text-4xl lg:text-5xl leading-tight mb-6 animate-fade-in-up animation-delay-400">
          ...
          <br />
          <span className="text-white">for your Business Effectively</span>
        </h3>
        ...
        <div className="animate-fade-in-up animation-delay-800">
          ...
          >
            <button className="group relative inline-flex items-center gap-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-bold text-lg px-10 py-5 rounded-full shadow-2xl hover:shadow-pink-500/50 hover:scale-110 transition-all duration-300 overflow-hidden">
              {/* Animated Background */}
              <div className="absolute inset-0 bg-gradient-to-r from-pink-600 to-purple-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              
              {/* Button Content */}
              <span className="relative z-10 flex items-center gap-3">
                <FaWhatsapp className={`text-2xl transition-transform duration-300 ${isHovered ? 'scale-125 rotate-12' : ''}`} />
