    ...
    <section className="relative bg-white py-16 sm:py-24">
      <div className="container mx-auto px-6 sm:px-8 lg:pl-[12rem] lg:pr-[11rem] grid grid-cols-1 lg:grid-cols-2 items-center gap-8 sm:gap-[80px]">
        ...
        <div className="pb-12 sm:pb-[86px] text-center sm:text-left">
          <h3 className="text-purple-700 uppercase text-[17px] font-bold"> Implementation Software</h3>
          ...
          <p className="text-gray-600 mt-4 mb-4 sm:mb-[15px] leading-relaxed tracking-wide text-justify">
            Odoo Implementation is a crucial process that can leverage your business. Odoo Implementers' highly skilled developers ensure that the entire process of Odoo implementation remains smooth without affecting the business operations.  
          </p>
