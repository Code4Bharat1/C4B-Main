      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <span className="font-semibold text-slate-900">odoo Implementer</span> is a proud official{" "}
              <span className="font-semibold text-purple-600">Gold partner of Odoo</span>,
              ...
              Implementation, Consultation and Integration for Odoo ERP.
            </motion.p>
              ...
              <div className="space-y-3">
                {features.map((feature, idx) => (
                  <motion.div
                    ...
                    whileHover={{ x: 8 }}
                    className="flex items-start gap-3 p-4 bg-white rounded-xl border border-slate-200 hover:border-purple-300 hover:shadow-md transition-all group"
                  >
                    <div className="w-6 h-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform">
          ...
          >
            ...
            >
              {/* Decorative glow */}
              <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 opacity-20 blur-3xl rounded-3xl scale-105" />
              ...
              {/* Gold Partner Badge */}
              <motion.div
                className="absolute -top-6 -right-6 bg-gradient-to-br from-yellow-500 to-orange-500 backdrop-blur-sm rounded-2xl p-4 shadow-2xl border-2 border-yellow-400"
                initial={{ opacity: 0, scale: 0 }}
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ delay: 0.5, type: "spring" }}
                whileHover={{ scale: 1.1, rotate: 5 }}
              >
                <FaAward className="w-8 h-8 text-white mb-2" />
                <div className="text-xs text-yellow-100 font-bold whitespace-nowrap">Gold Partner</div>
              </motion.div>

              {/* Experience Badge */}
              <motion.div
                className="absolute -bottom-6 -left-6 bg-gradient-to-br from-purple-500 to-pink-500 backdrop-blur-sm rounded-2xl p-4 shadow-2xl"
                initial={{ opacity: 0, scale: 0 }}
                whileInView={{ opacity: 1, scale: 1 }}
              ...
              >
                ...
                <div className="text-xs text-purple-100 font-medium whitespace-nowrap">Years Experience</div>
              </motion.div>
            </motion.div>
          </motion.div>
        </div>
