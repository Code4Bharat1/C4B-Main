  ...
  return (
    <div className="relative pt-20 h-screen min-h-[600px]">
        ...
        <div className="max-w-7xl w-full space-y-8">
          ...
          >
            <Link href="/">
              ...
              >
                <FaHome className="w-4 h-4 text-cyan-400 group-hover:text-cyan-300" />
            ...
            <div className="px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm rounded-lg border border-cyan-400/50">
              <span className="text-cyan-300 font-semibold text-sm">Odoo Consulting</span>
            </div>
          </motion.div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-cyan-400/30">
            ...
            <p className="text-lg sm:text-xl text-slate-300 max-w-2xl">
              Expert guidance to transform your business with Odoo ERP solutions
            </p>
          </motion.div>
          ...
          >
            <Link href="#contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/50 transition-all"
              >
                Get Started
              </motion.button>
            </Link>
      ...
      >
        ...
        >
          <div className="w-1.5 h-3 bg-gradient-to-b from-cyan-400 to-blue-500 rounded-full" />
        </motion.div>
      </motion.div>
    </div>
  );
