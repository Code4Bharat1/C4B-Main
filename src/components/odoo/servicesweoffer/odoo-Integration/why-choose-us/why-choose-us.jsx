    ...
    <section className="relative bg-white py-16 sm:py-24">
      <div className="container mx-auto px-6 lg:pl-48 lg:pr-48 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-4 sm:mt-4 lg:mt-[-80px]">
        ...
        <div className="pr-4 sm:pr-[79px] pl-4 sm:pl-[-1px]">
          ...
          Why Choose Oodu Implementers for Odoo Integration
          </h2>
          <p className="text-gray-500 text-sm sm:text-base leading-relaxed tracking-wide text-justify mt-[]">
          With a legacy of over 10 years, Oodu Implementers functions with technical expertise in all Odoo modules and delivers high coding standard services. We stand out from our competitors with our transparency and streamlined communication at every stage of the process.
          </p>
        </div>
        ...
        <div className="relative flex justify-center mt-8 sm:mt-0">
          <img
            src="https://www.odooimplementers.com/images/optimised-images/odoo-integration-modules-and-services.webp"
