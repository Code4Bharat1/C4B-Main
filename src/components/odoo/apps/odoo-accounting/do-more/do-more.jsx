      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-[10rem] grid grid-cols-1 lg:grid-cols-2 gap-[3rem] items-center">
        ...
        <div className="text-left">
          <p className="text-purple-700 text-sm sm:text-[17px] font-semibold uppercase tracking-wider mb-2">
           Odoo ACCOUNTING THAT ADAPTS TO YOUR BUSINESS
          </p>
          <h1 className="text-2xl sm:text-[28px] font-extrabold text-gray-800 mb-6 leading-snug">
           Do More with Odoo Accounting App
          </h1>
          <p className="text-gray-500 text-sm sm:text-base mb-4 leading-relaxed tracking-wide text-justify">
           Organize your core finance operations through flexible and comprehensive accounting controls. Odoo Accounting Software with cutting-edge features that will change your business. odoo Accounting Implementation brings you the most efficient Odoo accounting solutions from some of the most experienced and qualified IT professionals. Our unmatched support and successful implementation keep us ahead of our competitors.
          </p>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
          <div className="relative bg-white rounded-lg overflow-hidden w-full max-w-4xl">
            ...
            <iframe
              width="100%"
              height="500"
              src="https://www.youtube.com/embed/-FgcAUUsI7k?si=C5wV_gfuhCjMgtRX"
